...
def jogo2():
    ...
    while True:
        ...
        movimento.subir_descer_escada_1_2(joy_play, joysubindo, primeiro_nivel, segundo_nivel, escada, escada1, escada2, final_do_mapa_direita, teclado, janela, SpeedY, terceiro_nivel)
